  ...
  <div class="front-card">
    ...
    <div class="front-signin">
      <form action="checkLogin.jsp" class="signin" method="get">
        <div class="placeholding-input username hasome">
          <input type="text" class="text-input email-input" name="name" title="Username or email" autocomplete="on" tabindex="1" placeholder="Username or email">
        </div>
    ...
    <div class="front-signup">
      ...
      <form action="newUser.jsp" class="signup" method="get">
        <div class="fullname">
          <input type="text" id="signup-user-name" autocomplete="off" maxlength="45" name="name" placeholder="Full name">
        </div>
        <div class="email">
          <input type="text" id="signup-user-email" autocomplete="off" maxlength="45" name="email" placeholder="Username">
        </div>
        <div class="username">
          <input type="text" id="signup-username" autocomplete="off" maxlength="45" name="username" placeholder="test">
        </div>
        <div class="password">
          <input type="password" id="signup-user-password" autocomplete="off" maxlength="11" name="password" placeholder="Password">
        </div>
