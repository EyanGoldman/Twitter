...
<html lang="en">
  ...
  <div class="front-card">
    ...
    <div class="front-signin">
      <form action="Dalton_checkLogin.jsp" class="signin" method="get">
    ...
    <div class="front-signup">
      ...
      <form action="Dalton_newUser.jsp" class="signup" method="get">
        <div class="email">
          <input type="text" id="signup-user-email" autocomplete="off" maxlength="45" name="email" placeholder="Email">
        </div>
        <div class="password">
