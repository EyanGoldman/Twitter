...
//WHERE user_id = 2;
	 ...
	 String query = "SELECT tweet, user_id, tweet_time_stamp FROM tweet_t WHERE( tweet_t.tweet_id IN (SELECT DISTINCT f1.tweet_id FROM hashtag_relation AS f1, hashtag_relation AS f2 WHERE f1.tweet_id = f2.tweet_id AND f1.hashtag_id = "+ hashtag +" ))ORDER BY tweet_time_stamp DESC";
